...
<footer className="footer-style mt-auto">
      <Container>
        <Row className="align-items-center" style={{ minHeight: '6rem' }}>
          <Col className="text-center my-1" xs="12"  md="4">
            <Image src={logo} alt="logo" style={{ height: '5rem' }} />
          </Col>
          <Col className="d-flex flex-column align-items-center mb-3 mb-md-0" xs="12" md="4">
            ...
            <a className="d-flex justify-content-center text-decoration-none text-white mb-2" target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/rodrigo-mendoza-b8b6931a4/">
          ...
          <Col className="d-flex flex-column align-items-center mb-3 mb-md-0" xs="12" md="4">
            ...
            <h5 className="text-white mb-2">Tucumán - Argentina 2021</h5>
          </Col>
        </Row>
      </Container>
    </footer>
